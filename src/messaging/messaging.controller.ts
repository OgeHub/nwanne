...
export class MessagingController {
    constructor(private messagingService: MessagingService, private messagingGateway: MessagingGateway) {}
    ...
    const newMessage = await this.messagingService.create(id, createMessageDto.message);
